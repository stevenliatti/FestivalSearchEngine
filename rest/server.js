 ...
 * @apiSuccess {String}   events.id Event's id (from Eventful)
 ...
 * @apiSuccess {String}   events.offer Event's offer URL from Eventful (to buy ticket for example)
 *
 ...
 * @apiSuccess {String}   tracks.id Tracks's id (from Spotify)
