...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Découverte de bonnes (Spotify, Wikipédia) et "moins bonnes" (MusicBrainz, Eventful) APIs
	\end{itemize}
	Vincent :
	\begin{itemize}
		\item Développement d'un frontend, études de pleins d'APIs et surtout JQuery
